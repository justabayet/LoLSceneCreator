...
function init() {
    ...
    textureLoader.load('public/assets/bg.png', function (texture) {
...
function initGUI() {
    ...
    $.getJSON('public/assets/index2name.json', function (data) {
        // load index2name
        $.each(data, function (key, val) {
            index2name[key] = val;
        });
        // load index2skin
        $.getJSON('public/assets/index2skin.json', function (data) {
            $.each(data, function (key, val) {
                index2skin[key] = val;
            });
    ...
    $.getJSON('public/assets/name2index.json', function (data) {
        $.each(data, function (key, val) {
            name2index[key] = val;
        });
    });
